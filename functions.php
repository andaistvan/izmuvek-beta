...
function trebi_setup()
{
    ...
    register_nav_menus(array(
        ...
        'singlepage' => esc_html__('Single', 'trebi'),
        'singlemobil' => esc_html__('Singlemobil', 'trebi'),
    ));
...
function trebi_scripts()
{
    ...
    wp_enqueue_script('addtocartarchive', get_stylesheet_directory_uri().'/dev/addtocartarchive.js', array('jquery'));
...
/**
 * Load wc-fields-factory.
 */
require get_template_directory().'/inc/wc-fields-factory.php';

/**
 * Load wc-costom-product-data-fields.
 */
require get_template_directory().'/inc/wc-costom-product-data-fields.php';

/**
 * checkout-functions.
 */
require get_template_directory().'/inc/checkout-functions.php';
...
/**
 * Load wc-li-items-functions.
 */
// require get_template_directory().'/inc/wc-li-items-functions.php';

/**
 * meta-to-cart-order-functions.
 */
require get_template_directory().'/inc/meta-to-cart-order-functions.php';

/**
 * Load wc-admin-menu-orders.
 */
require get_template_directory().'/inc/wc-admin-menu-orders.php';

/*
 * cart-minicart
 */
 require get_template_directory().'/inc/cart-minicart.php';
